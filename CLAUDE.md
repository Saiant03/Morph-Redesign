...
- 2026-09-25: Faza C4.2b (magazinul din București) încheiată. `/magazin` are ordinea: sosirea (adresa cu „Sector 1”, programul, „Deschide în Google Maps” spre linkul Morph `maps.app.goo.gl/BtVSJc4s7KvkUQh57`, „Sună la magazin”, comenzi online și asistență separat, cu „S–D închis”) → „Cum încerci” (răspunsul FAQ Morph citat și cele trei rânduri din ghidul Morph, cu surse) → „Selecția ta” (nu rezervă, nu arată stocul; link spre `/descopera#incearca`) → „Recenzii despre magazin” (o frază-rezumat a conceptului, datată, și un singur link Google; fără citate, nume, cifre sau stele) → Certilogo → Despre Morph. Programul are o singură sursă: `SHOP_HOURS` în `lib/catalog.ts`. Pe PDP: „Parfumurile Morph se pot testa în magazinul din București.” Au fost scoase „159”, „Toate cele trei colecții” și căutarea generică pe hartă. Metroul nu apare (ruta nu a fost verificată). Document: `docs/design/phase-c4-2b-store.md`. Test: `npm run smoke`, 64 de verificări, toate trecute la ultima rulare pe server proaspăt. Rulările anterioare au avut 6 timeout-uri intermitente pe `/descopera` și în Finder, care apar și pe `6d5148a`: cauza e o cerere `/_next/image` întreruptă care blochează cheia în Next 16.3.6 până la repornirea serverului. C4.3 doar la cerere.
- 2026-09-25: Faza C4.3a (doar plan, fără cod) încheiată: `docs/design/phase-c4-3-gifting-newsletter-plan.md`. Verificat pe 2026-09-25: gift card-ul are 5 valori (230, 360, 690, 790, 1.100 lei), se cumpără și se folosește doar online, e trimis pe e-mail (cu „De la” și mesaj opțional de până la 500 de caractere), e valabil 180 de zile și nu se returnează. Cutia cadou costă 20 lei și apare pe PDP doar la 100 ml, travel, mostre și gel. Newsletter-ul Morph e un formular Breakdance pe domeniul Morph, fără niciun stimulent declarat; conceptul trimite spre pagina Morph și nu are formular propriu. „Voucher cadou” 150 RON e activ până pe 29 oct. 2026 și rămâne exclus. Snapshot-ul e identic cu API-ul live. C4.3b doar la cerere, după deciziile din §9.
